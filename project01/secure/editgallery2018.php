                ...
                <div class="container _nightblue">
                    ...
                    <div class="col-sm-12 col-md-12  col-lg-12 ">
                        ...
                        <div class="section">
                            ...
                            <h1>Edit the 2018 Gallery</h1>

                            <div class="row">

                                <div class='card large'>
                                    <a href="addgallery2018.php">
                                        <div class='section'>
                                            <h3>Add an image </h3>
                                            <h6>Add an image to the 2018 gallery</h6>
                                        </div>
                                    </a>
                                </div>
                                
                                <div class='card large'>
                                    <a href="removegallery2018.php">
                                        <div class='section'>
                                            <h3>Remove an image </h3>
                                            <h6>Remove an image from the 2018 gallery</h6>
                                        </div>
                                    </a>
                                </div>
