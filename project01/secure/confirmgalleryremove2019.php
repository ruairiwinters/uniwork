...
$readquery = "SELECT * FROM malahide_gallery2019 WHERE id = '$imageid'";
$removequery = "DELETE FROM `malahide_gallery2019` WHERE id = '$imageid'";
                ...
                <div class="container _nightblue">
                    ...
                    <div class="col-sm-12 col-md-12  col-lg-12 ">
                        ...
                        <div class="section">
                            ...
                            <a href="../gallery2019.php"><h6 style="color: #ffffff">View the gallery</h6></a>
