...
$updatequery = "UPDATE malahide_lineup SET name='$newtitle', description='$newdesc', genre='$newgenre', song='$newsong', date='$newdate', image1='$sentfilename1', image2='$sentfilename2', image3='$sentfilename3' WHERE id = '$idupdate'";
            ...
            <div class="col m10 _nightblue">
                <div class="container _nightblue">
                    ...
                    <div class="col-sm-12 col-md-12  col-lg-12 ">
                        ...
                        <div class="section">
                            <h1>Changes Confirmed</h1>
                            
                            <?php
                            echo "<h4> Details have been changed for $newtitle</h4>"
                                ?>
